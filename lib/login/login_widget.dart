                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      setState(() {
                                        ...
                                        FFAppState().Cobertura = null;
                                      });
                                      _model.getCadenas = await GetValuesGroup
                                          .getCadenasAllCall
                                          .call();
                                      if ((_model.getCadenas?.succeeded ??
                                          true)) {
                                        setState(() {
                                      ...
                                      _model.getProcessingTypeCode =
                                          await GetValuesGroup
                                              .getProcessingTypeCodeCall
                                              .call();
                                      if ((_model.getProcessingTypeCode
                                              ?.succeeded ??
                                          true)) {
                                        setState(() {
                                      ...
                                      _model.getGarantia = await GetValuesGroup
                                          .getAplicaGarantiaCall
                                          .call();
                                      if ((_model.getGarantia?.succeeded ??
                                          true)) {
                                        setState(() {
