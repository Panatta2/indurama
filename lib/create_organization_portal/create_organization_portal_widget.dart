...
import 'create_organization_portal_model.dart';
export 'create_organization_portal_model.dart';

class CreateOrganizationPortalWidget extends StatefulWidget {
  const CreateOrganizationPortalWidget({
    Key? key,
  ...
  @override
  _CreateOrganizationPortalWidgetState createState() =>
      _CreateOrganizationPortalWidgetState();
}

class _CreateOrganizationPortalWidgetState
    extends State<CreateOrganizationPortalWidget> {
  late CreateOrganizationPortalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateOrganizationPortalModel());
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          FutureBuilder<ApiCallResponse>(
                                            future: GetValuesGroup.stateCodeCall
                                                .call(),
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (_model.seleccionarProvinciaValue ==
                                          null) {
                                      ...
                                      if (_model.seleccionarCantonValue ==
                                          null) {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                          SnackBar(
                                            content: Text(
                                              'Debe seleccionar un canton',
                                              style: TextStyle(
                                                color:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
                                      ...
                                      if (_model.seleccionarParroquiasValue ==
                                          null) {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                          SnackBar(
                                      ...
                                      if (getJsonField(
                                        ...
                                        _model.createOrganization =
                                          ...
                                          taxId: _model.cedulaController.text,
                                          street:
                                              _model.direccionController.text,
                                          houseNumber: ' ',
                                          zIdProvinciaSDK: ' ',
                                        ...
                                        if ((_model.createOrganization
                                                ?.succeeded ??
                                            true)) {
                                          _model.getOrganization =
                                              await ClientsGroup
                                            ...
                                            cedula: getJsonField(
                                              (_model.createOrganization
                                                      ?.jsonBody ??
                                                  ''),
                                              r'''$.d.results.NIdentificacin_KUT''',
                                            ).toString(),
                                          );
                                          if ((_model
                                                  .getOrganization?.succeeded ??
                                              true)) {
                                            setState(() {
                                              FFAppState().userIndurama =
                                                  getJsonField(
