...
import 'set_cliente_organizacion_model.dart';
export 'set_cliente_organizacion_model.dart';

class SetClienteOrganizacionWidget extends StatefulWidget {
  const SetClienteOrganizacionWidget({
    Key? key,
  ...
  @override
  _SetClienteOrganizacionWidgetState createState() =>
      _SetClienteOrganizacionWidgetState();
}

class _SetClienteOrganizacionWidgetState
    extends State<SetClienteOrganizacionWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SetClienteOrganizacionModel());
