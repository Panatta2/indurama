...
import 'select_client_organizacion_model.dart';
export 'select_client_organizacion_model.dart';

class SelectClientOrganizacionWidget extends StatefulWidget {
  const SelectClientOrganizacionWidget({
    Key? key,
  ...
  @override
  _SelectClientOrganizacionWidgetState createState() =>
      _SelectClientOrganizacionWidgetState();
}

class _SelectClientOrganizacionWidgetState
    extends State<SelectClientOrganizacionWidget> {
  late SelectClientOrganizacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectClientOrganizacionModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        ...
        FFAppState().userCedula = getJsonField(
          widget.clients,
          r'''$.d.results[0].NIdentificacin_KUT''',
        ).toString().toString();
      });
    });
