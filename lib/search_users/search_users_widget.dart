                          ...
                          child: Builder(
                            builder: (context) {
                              ...
                              return ListView.builder(
                                ...
                                itemCount: searchAdmin.length,
                                itemBuilder: (context, searchAdminIndex) {
                                  final searchAdminItem =
                                      searchAdmin[searchAdminIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        12.0, 8.0, 12.0, 8.0),
                                    child: Container(
                                              ...
                                              FlutterFlowIconButton(
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  if (confirmDialogResponse) {
                                                    _model.apiResultfyf2 =
                                                        await DeleteUserCall
                                                            .call(
                                                      token: currentJwtToken,
                                                      uid: searchAdminItem.uid,
                                                    );
                                                    _shouldSetState = true;
                                                    if ((_model.apiResultfyf2
                                                            ?.succeeded ??
                                                        true)) {
                        ...
                        Padding(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => Builder(
                              builder: (context) {
                                final searchAdmin = _model.simpleSearchResults
                                    .where((e) =>
                                        valueOrDefault(
